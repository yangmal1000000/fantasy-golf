...
export const MAJOR_THEMES: Record<string, MajorTheme> = {
  masters: {
    ...
    badgeClass: "bg-[#f5c518] text-[#003820] border-[#f5c518]",
    tableHeaderBg: "bg-[#003820]",
    tableHeaderText: "text-[#f5c518]",
    tableHeaderTextSecondary: "text-white/70",
    winnerCardClass: "border-2 border-[#f5c518] bg-gradient-to-br from-[#f5c518]/20 via-[#006747]/10 to-transparent",
    winnerIconBg: "bg-[#f5c518]",
    runnerUpCardClass: "border-[#006747]/40 bg-gradient-to-br from-[#006747]/15 to-transparent",
    cutLineClass: "text-[#006747] dark:text-[#3da06a]",
    cutBadgeClass: "bg-[#f5c518]/20 text-[#003820] border-[#f5c518]/60",
    statsAccent: "text-[#006747] dark:text-[#3da06a]",
    potCardClass: "border-2 border-[#f5c518]/60 bg-gradient-to-r from-[#f5c518]/20 via-[#006747]/10 to-transparent",
    liveBadgeClass: "bg-[#c44545] text-white",
    positionFirst: "bg-[#f5c518] text-[#1a1a1a]",
    tierHeaderClass: "bg-[#006747]/15 dark:bg-[#003820]/40 border-b-2 border-[#f5c518]/50",
    borderAccent: "border-l-4 border-l-[#f5c518] border border-zinc-200 dark:border-zinc-800",
    winnerEmoji: "🌱",
  ...
  "pga-championship": {
    ...
    badgeClass: "bg-[#d4a843] text-[#0d1f3c] border-[#d4a843]",
    tableHeaderBg: "bg-[#0d1f3c]",
    tableHeaderText: "text-[#d4a843]",
    tableHeaderTextSecondary: "text-white/70",
    winnerCardClass: "border-2 border-[#d4a843] bg-gradient-to-br from-[#d4a843]/20 via-[#1a3a6b]/10 to-transparent",
    winnerIconBg: "bg-[#d4a843]",
    runnerUpCardClass: "border-[#1a3a6b]/40 bg-gradient-to-br from-[#1a3a6b]/15 to-transparent",
    cutLineClass: "text-[#1a3a6b] dark:text-[#5b8dd9]",
    cutBadgeClass: "bg-[#d4a843]/20 text-[#0d1f3c] border-[#d4a843]/60",
    statsAccent: "text-[#1a3a6b] dark:text-[#5b8dd9]",
    potCardClass: "border-2 border-[#d4a843]/60 bg-gradient-to-r from-[#d4a843]/20 via-[#1a3a6b]/10 to-transparent",
    liveBadgeClass: "bg-[#c44545] text-white",
    positionFirst: "bg-[#d4a843] text-[#1a1a1a]",
    tierHeaderClass: "bg-[#1a3a6b]/15 dark:bg-[#0d1f3c]/40 border-b-2 border-[#d4a843]/50",
    borderAccent: "border-l-4 border-l-[#d4a843] border border-zinc-200 dark:border-zinc-800",
    winnerEmoji: "🏆",
    pattern: "pga-pattern",
  },
  "us-open": {
    ...
    badgeClass: "bg-[#c0c5ce] text-[#0a1428] border-[#c0c5ce]",
    tableHeaderBg: "bg-[#0a1428]",
    tableHeaderText: "text-[#c0c5ce]",
    tableHeaderTextSecondary: "text-white/60",
    winnerCardClass: "border-2 border-[#c0c5ce] bg-gradient-to-br from-white/20 via-[#1a2540]/10 to-transparent",
    winnerIconBg: "bg-[#c0c5ce]",
    runnerUpCardClass: "border-[#1a2540]/40 bg-gradient-to-br from-[#1a2540]/15 to-transparent",
    cutLineClass: "text-[#1a2540] dark:text-[#8b95a8]",
    cutBadgeClass: "bg-white/20 text-[#0a1428] border-[#c0c5ce]/60",
    statsAccent: "text-[#1a2540] dark:text-[#8b95a8]",
    potCardClass: "border-2 border-[#c0c5ce]/60 bg-gradient-to-r from-white/20 via-[#1a2540]/10 to-transparent",
    liveBadgeClass: "bg-[#c44545] text-white",
    positionFirst: "bg-[#c0c5ce] text-[#0a1428]",
    tierHeaderClass: "bg-[#1a2540]/15 dark:bg-[#0a1428]/40 border-b-2 border-[#c0c5ce]/50",
    borderAccent: "border-l-4 border-l-[#c0c5ce] border border-zinc-200 dark:border-zinc-800",
    winnerEmoji: "🏛️",
  ...
  "the-open": {
    ...
    accentHex: "#d4a843",
    accentHexLight: "#e8c558",
    badgeClass: "bg-[#d4a843] text-[#4a0d0d] border-[#d4a843]",
    tableHeaderBg: "bg-[#4a0d0d]",
    tableHeaderText: "text-[#d4a843]",
    tableHeaderTextSecondary: "text-white/70",
    winnerCardClass: "border-2 border-[#d4a843] bg-gradient-to-br from-[#d4a843]/20 via-[#7c1a1a]/10 to-transparent",
    winnerIconBg: "bg-[#d4a843]",
    runnerUpCardClass: "border-[#7c1a1a]/40 bg-gradient-to-br from-[#7c1a1a]/15 to-transparent",
    cutLineClass: "text-[#7c1a1a] dark:text-[#d45]",
    cutBadgeClass: "bg-[#d4a843]/20 text-[#4a0d0d] border-[#d4a843]/60",
    statsAccent: "text-[#7c1a1a] dark:text-[#d45]",
    potCardClass: "border-2 border-[#d4a843]/60 bg-gradient-to-r from-[#d4a843]/20 via-[#7c1a1a]/10 to-transparent",
    liveBadgeClass: "bg-[#c44545] text-white",
    positionFirst: "bg-[#d4a843] text-[#1a1a1a]",
    tierHeaderClass: "bg-[#7c1a1a]/15 dark:bg-[#4a0d0d]/40 border-b-2 border-[#d4a843]/50",
    borderAccent: "border-l-4 border-l-[#d4a843] border border-zinc-200 dark:border-zinc-800",
    winnerEmoji: "🏆",
