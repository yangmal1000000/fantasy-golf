          ...
          <div className="overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-[#1a1d1c]"
            ...
            <div className="relative h-36 overflow-hidden sm:h-48">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 text-white sm:p-6">
                ...
                <p className="mt-0.5 text-xs text-white/90 drop-shadow sm:text-sm flex items-center gap-1">
                  <MapPinIcon className="inline h-3 w-3" /> {tournament.course} · {formatDateRange(tournament.startDate, tournament.endDate)}
                </p>
              </div>
            </div>
            {/* Stats */}
